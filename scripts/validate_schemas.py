...
docs/versioning.md, CHANGELOG.md, and docs/openapi.yaml.
...
def _version_from_openapi(root: Path) -> str | None:
    """info.version in docs/openapi.yaml, normalized to a "vX.Y.Z" string."""
...
def validate_version_sync(root: Path) -> list[str]:
    ...
    CHANGELOG.md, and docs/openapi.yaml -- the exact drift the release
    ...
    sources = {
        ...
        "docs/openapi.yaml": _version_from_openapi(root),
    }
    failures: list[str] = []
